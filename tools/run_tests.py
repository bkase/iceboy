...
SUITES: tuple[SuiteDefinition, ...] = (
    ...
    SuiteDefinition("meta", "test_ppu_external_assets.py", "python", "tools.tests.test_ppu_external_assets"),
    SuiteDefinition("meta", "test_ppu_evidence.py", "python", "tools.tests.test_ppu_evidence"),
    ...
    SuiteDefinition("meta", "test_ppu_wave_c_reference.py", "python", "tools.tests.test_ppu_wave_c_reference"),
    SuiteDefinition("meta", "test_activity_capture.py", "python", "tools.tests.test_activity_capture"),
    SuiteDefinition(
        "meta",
        "test_encoding_optimization_evaluation.py",
        "python",
    ...
    SuiteDefinition("unit", "test_rom_spram.py", "swim", "test/unit/test_rom_spram.py"),
    SuiteDefinition("unit", "test_frame_sink.py", "swim", "test/unit/test_frame_sink.py"),
    SuiteDefinition("unit", "test_hram_ebr.py", "swim", "test/unit/test_hram_ebr.py"),
    SuiteDefinition("unit", "test_access_policy.py", "swim", "test/ppu/unit/test_access_policy.py"),
    SuiteDefinition("unit", "test_bg_fetcher.py", "swim", "test/ppu/unit/test_bg_fetcher.py"),
    SuiteDefinition("unit", "test_bg_transfer_live.py", "swim", "test/ppu/unit/test_bg_transfer_live.py"),
    SuiteDefinition("unit", "test_bg_fifo.py", "swim", "test/ppu/unit/test_bg_fifo.py"),
    SuiteDefinition("unit", "test_line_summary.py", "swim", "test/ppu/unit/test_line_summary.py"),
    SuiteDefinition("unit", "test_oam_dma_mode2.py", "swim", "test/ppu/unit/test_oam_dma_mode2.py"),
    SuiteDefinition("unit", "test_scanout_blank.py", "swim", "test/ppu/unit/test_scanout_blank.py"),
    SuiteDefinition("unit", "test_obj_transfer_live.py", "swim", "test/ppu/unit/test_obj_transfer_live.py"),
    SuiteDefinition("unit", "test_mixer.py", "swim", "test/ppu/unit/test_mixer.py"),
    SuiteDefinition("unit", "test_obj_observe.py", "swim", "test/ppu/unit/test_obj_observe.py"),
    SuiteDefinition("unit", "test_obj_priority.py", "swim", "test/ppu/unit/test_obj_priority.py"),
    SuiteDefinition("unit", "test_obj_fetch.py", "swim", "test/ppu/unit/test_obj_fetch.py"),
    SuiteDefinition("unit", "test_oam_scan.py", "swim", "test/ppu/unit/test_oam_scan.py"),
    SuiteDefinition("unit", "test_oam_ebr.py", "swim", "test/unit/test_oam_ebr.py"),
    SuiteDefinition("unit", "test_window.py", "swim", "test/ppu/unit/test_window.py"),
    ...
    SuiteDefinition("unit", "test_stat_irq.py", "swim", "test/ppu/unit/test_stat_irq.py"),
    SuiteDefinition("unit", "test_ppu_invariants.py", "swim", "test/ppu/unit/test_ppu_invariants.py"),
    ...
    SuiteDefinition("unit", "test_joypad.py", "swim", "test/unit/test_joypad.py"),
    SuiteDefinition("unit", "test_joypad_interrupts.py", "swim", "test/unit/test_joypad_interrupts.py"),
    ...
    SuiteDefinition("unit", "test_interrupts_basic.py", "swim", "test_interrupts_basic"),
    SuiteDefinition("unit", "test_regs.py", "swim", "test_regs"),
    SuiteDefinition("unit", "test_spram.py", "swim", "test/unit/test_spram.py"),
    ...
    SuiteDefinition("rom", "test_icebreaker_alu_loop.py", "shell", "tools/run_icebreaker_alu_loop_verilator.sh"),
    ...
    SuiteDefinition("rom", "test_mbc3_ram.py", "swim", "test/rom/test_mbc3_ram.py"),
    ...
    SuiteDefinition("rom", "test_cpu_instrs_blargg.py", "shell", "tools/run_cpu_instrs_blargg_verilator.sh"),
    ...
    SuiteDefinition("rom", "test_ppu_checker_ball.py", "shell", "tools/run_ppu_checker_ball_verilator.sh"),
    ...
    SuiteDefinition("lockstep", "test_ei_halt_corners.py", "swim", "test_ei_halt_corners"),
    ...
    SuiteDefinition("invariant", "test_soc_lockstep_top.py", "swim", "test/harness/test_soc_lockstep_top.py"),
    SuiteDefinition("invariant", "test_soc_rom_top.py", "swim", "test/harness/test_soc_rom_top.py"),
