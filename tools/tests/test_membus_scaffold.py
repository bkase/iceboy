...
class MembusScaffoldTest(unittest.TestCase):
    ...
    def test_membus_contract_matches_wave_a_memory_map(self) -> None:
        ...
        for symbol in [
            ...
            "let (rom_data, dma_rom_data) = inst rom_image_spram(",
