...
class HardwareSocCoreAssetsTest(unittest.TestCase):
    def test_hardware_soc_core_exports_hw_safe_nucleus_and_test_top(self) -> None:
        ...
        self.assertIn("pub entity hardware_soc_core_visible(", soc_text)
        self.assertIn("pub entity hardware_soc_core_visible_bg_static_1k(", soc_text)
        self.assertIn("pub entity hardware_soc_core_visible_joypad_bg_smoke_2k(", soc_text)
        self.assertIn("pub entity hardware_soc_core_rw(", soc_text)
        self.assertIn("use lib::ppu::rtl::core_hw_bg_window", soc_text)
        self.assertIn("joypad_visible", soc_text)
